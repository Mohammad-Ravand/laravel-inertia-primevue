...
const listPosts =computed(()=> props.news.data);
            ...
            <Card class="w-full mb-10 pb-10 md:w-4/5   lg:w-3/5 xl:w-2/5">
                <template #header>
                    ...
                    <figure class="h-96 overflow-hidden">
                        <img class="object-fill w-full rounded-lg" :src="props.news.image" alt="image description">
                ...
                <template #content>
                    ...
                    <div class="flex gap-1 flex-wrap h-30">
                        <NewsCategories :categories="news.categories" />
                    </div>
